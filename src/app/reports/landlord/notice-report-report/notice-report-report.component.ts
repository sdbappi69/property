...
@Component({
  selector: 'app-notice-report-report',
  templateUrl: './notice-report-report.component.html',
  styleUrls: ['./notice-report-report.component.scss']
})
export class NoticeReportReportComponent implements AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.dataSource.reportLoad('/custom-reports/notice');
