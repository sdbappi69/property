...
@Component({
  selector: 'app-due-statement-report',
  templateUrl: './due-statement-report.component.html',
  styleUrls: ['./due-statement-report.component.scss']
})
export class LandlordDueStatementReportComponent implements AfterViewInit {
  title = 'htmltopdf';
