...
export const LANDLORD_ROUTES: RouteInfo[] = [
    ...
    { path: '/settings/user', title: 'robi.sidebar.setting',  icon: 'settings', class: '', permission: ['am-landlord'] },
...
export const TENANT_ROUTES: RouteInfo[] = [
    ...
    { path: '/reports', title: 'Reports',  icon: 'account_tree', class: '', permission: ['am-tenant'] },
];
